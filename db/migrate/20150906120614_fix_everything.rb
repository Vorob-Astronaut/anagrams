class FixEverything < ActiveRecord::Migration
  def change
    ...
    rename_column :titles, :key_art, :key_art
    ...
    rename_column :titles, :key_art_file_name, :key_art_file_name
    rename_column :titles, :key_art_content_type, :key_art_content_type
    rename_column :titles, :key_art_file_size, :key_art_file_size
    rename_column :titles, :key_art_updated_at, :key_art_updated_at
